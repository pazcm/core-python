...
"""
Test2>
function that accepts a list of numbers and returns True if the list contains an even number of even numbers.
"""
def even_number_of_evens(numbers):
    """
...
# the developer know
print("Hi Marta, All tests passed!")
...
# If all the test cases pass, print some successful info to the console to let
# the developer know
print("All tests passed! TDD way")