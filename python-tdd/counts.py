...
assert count_upper_case1("") == 0, "Empty string"
assert count_upper_case1("A") == 1, "One upper case"
assert count_upper_case1("a") == 0, "One lower case"
assert count_upper_case1("£$%%^") == 0, "Special characters"
...
2) Test>
    ...
    2. Add more tests until be sure that the code is correct.
